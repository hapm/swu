...
public class ChunkInfo {
	...
	/**
	 * Saves a list of all block types, that where already broken in the represented Chunk.
	 */
	...
	/**
	 * Saves a list of all block types, that where already placed in the represented Chunk.
	 */	
	@ManyToMany(cascade=CascadeType.ALL)
	...
	/**
	 * Used as the generator version for Chunk, where swu couldn't get the generator version for.
	 */
	...
	/**
	 * Initializes a new instance of the ChunkInfo class.
	 * @param id The id of the ChunkInfo to create.
	 * @param generatorVersion The generator version used to create the Chunk represented by
	 *                         the ChunkInfo to create.
	 * @param firstSeen The time in ms, when the chunk was seen the first time.
	 */
	...
	/**
	 * Gets the version of the generator used to generate the Chunk
	 * represented by this ChunkInfo.
	 * 
	...
	/**
	 * Gets the time when the Chunk represented by this ChunkInfo was first seen.
	 * 
	...
	/**
	 * Gets a list of all BlockTypeInfos placed in the Chunk represented by this ChunkInfo.
	 * 
	...
	/**
	 * Gets a list of all BlockTypeInfos broken in the Chunk represented by this ChunkInfo.
	 * 
	 * @return The list of BlockTypeInfos.
	 */
