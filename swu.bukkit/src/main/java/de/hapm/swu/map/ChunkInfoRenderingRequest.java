...
/**
 * Data class holding all information needed to render a map from a set of ChunkInfos.
 * 
...
public class ChunkInfoRenderingRequest {
	...
	/**
	 * Initializes a new instance of the {@link ChunkInfoRenderingRequest} class.
	 * 
	 * @param id The id of the map, the rendering should be done for.
	 * @param centerX The current world x coordinate in the center of the map.
	 * @param centerZ The current world y coordinate in the center of the map.
	 * @param world The name of the world, to render the map for.
	 */
	...
	/**
	 * Gets the x world coordinates for for the center of the map, that should be rendered.
	 * 
	...
	/**
	 * Gets the z world coordinates for the center of the map, that should be rendered.
	 * 
	 ...
	 * 
	 * @return A number between 0 and 127, indicating a line that wasn't rendered fo rthe longest time.
	 */
	public int nextLine() {
		lastLine += 4;
		if (lastLine > 127) {
	...
	/**
	 * Checks if the background rendering task has at least rendered this image once.
	 * 
	 * @return Returns true, if there was at least one complete rendering cycle for this
	 ...
	 * 
	 * @param Set to true to mark this request as done, to false otherwise.
	 */
