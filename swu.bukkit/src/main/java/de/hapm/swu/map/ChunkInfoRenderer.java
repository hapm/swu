...
public class ChunkInfoRenderer extends MapRenderer {
    /**
     * Saves all active ChunkInfoRenderingRequests indexed by the map id using
     * it.
     */
    ...
    /**
     * Initializes a new ChunkInfoRenderer instance and associates it with the
     * given plugin.
     * 
     * @param plugin
     *            The SmoothWorldUpdaterPlugin instance, this renderer belongs
     *            to.
     */
