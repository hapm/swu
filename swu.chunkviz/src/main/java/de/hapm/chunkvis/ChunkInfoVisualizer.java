...
public class ChunkInfoVisualizer {
	...
	public void draw(Graphics2D g) {
		...
		paintTransform.transform(new Point2D.Double(g.getClipBounds().getMinX(), g.getClipBounds().getMinY()), minXY);
		paintTransform.transform(new Point2D.Double(g.getClipBounds().getMaxX(), g.getClipBounds().getMaxY()), maxXY);
