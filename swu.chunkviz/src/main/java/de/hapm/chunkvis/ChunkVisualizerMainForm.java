...
public class ChunkVisualizerMainForm {
	...
	public ChunkVisualizerMainForm() {
		initialize();
		final RepaintManager currentManager = RepaintManager.currentManager(chunkInfoPanel);
	...
	private void initialize() {
		...
		frame.addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent e) {
				...
				dataSourceConfig.setUrl("jdbc:sqlite:C:/Users/markus/Entwickeln/Java/CraftBukkitTestServer/plugins/SmoothWorldUpdater/SmoothWorldUpdater.db");
				...
				dataSourceConfig.setIsolationLevel(TransactionIsolation.getLevel("READ_UNCOMMITTED"));
